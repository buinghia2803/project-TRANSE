class preQuestionReReply {
    ...
    setFormPageSubmitForm() {
        $('input[type=submit]').on('click', function() {
            if($(this).hasClass('saveDraftGoToAnkenTop')) {
                $('.from_page').val(u202N_DRAFT)
            } else {
                $('.from_page').val(u202N_DRAFT_REDIRECT_KAKUNIN)
            }
