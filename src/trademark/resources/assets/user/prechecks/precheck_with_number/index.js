...
$('.add-product-service').click(function () {
    ...
    $(this).parent().parent().before(`
        <tr class="before_html_product">
            <td class="eDis">
                <select name="prod[${lengthAppend}][m_distinction_id]" class="data-m_distinction_id distinction-mr">
                    <option value="">${label_select_default}</option>
                    ${optionDISTINCTION}
                </select>
            </td>
            <td class="boxes boxes_${lengthAppend}"><input type="text" name="prod[${lengthAppend}][name_product]" class="data-name_product name_prod_${lengthAppend}" key-prod="${lengthAppend}" data-suggest nospace></td>
            <td class="center"><input type="checkbox" name="prod[${lengthAppend}][check]" value="1" class="checkSingleCheckBox" data-name-distinction=""/></td>
        </tr>
    `);
...
$(document).on('click', '[prod_value]', function () {
    ...
    var prodId = self.attr('product-id')
...
$('body').on('click', 'input[type=submit],button[type=submit]', function(e) {
    $('input.data-name_product').change();
    $('select.data-m_distinction_id').change();
