    ...
    <div id="contents">
        ...
        <div class="wide clearfix">
            <form action="{{ route('admin.refusal.create-request.update_data_alert', ['id' => $id]) }}" id="form"
                ...
                <!-- ↑↑管理画面共通【基本情報】とボタン↑↑ -->
                <h3>{{ __('labels.a210.text_over') }}</h3>
                ...
                <dl class="w12em clearfix">
                    ...
                    <dd>{{ __('labels.a210.text_11_over') }}</dd>
                </dl>
                ...
                <ul class="footerBtn clearfix" id="footerBtn">
                    <li><input type="button" value="{{ __('labels.a210.back') }}" class="btn_a" onclick="history.back()"/></li>
                ...
                <input type="hidden" name="from_page" value="{{ A210Over }}">
            </form>
        </div>
        <!-- /contents inner -->
    </div>
