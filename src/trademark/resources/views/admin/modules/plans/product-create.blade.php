...
@section('main-content')
    <div id="contents">
        <div class="wide clearfix">
            ...
            <form id="form" action="{{ route('admin.refusal.response-plan.product.create.post', [
                ...
                <ul class="footerBtn clearfix">
                    ...
                    <li><input type="submit" name="{{ SUBMIT }}" value="{{ __('labels.btn_confirm') }}" class="btn_c"></li>
                </ul>
            </form>
        </div>
    </div>
...
@section('footerSection')
    ...
    <script>
        ...
        const productHTML = '{!! \CommonHelper::minifyHtml(view('admin.modules.plans.partials.block-product', [
            'plans' => $plans,
        ])->render()) !!}';
        const distinctHTML = '{!! \CommonHelper::minifyHtml(view('admin.modules.plans.partials.block-distinct', [
            'plans' => $plans,
            'distinctions' => $distinctions,
        ])->render()) !!}';
    </script>
    <script src="{{ asset('admin_assets/pages/plans/product-create.js') }}"></script>
    @if($isBlockScreen)
