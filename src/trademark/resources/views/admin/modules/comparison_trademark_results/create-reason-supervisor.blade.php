...
@section('main-content')
    <div id="contents">
        ...
        <div class="wide clearfix">
            ...
            <form id="form" method="POST" action="{{route('admin.refusal.eval-report.create-reason.supervisor.post')}}">
                ...
                <ul class="footerBtn clearfix">
                    ...
                    @if(isset($reasonNo) && $reasonNo->is_confirm == 1)
                        <li><input type="button" value="{{__('labels.refusal.eval_report_create_reason.page2')}}" class="btn_c no_disabled"
                            onclick="window.location = '{{ route('admin.refusal.eval-report.create-examine.supervisor', [
