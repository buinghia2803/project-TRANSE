...
@section('main-content')
    <div id="contents">
        <div class="wide clearfix">
            ...
            <form id="form" action="{{ route('admin.refusal.eval-report.edit-examine.supervisor.post', $comparisonTrademarkResult->id) }}" method="post">
                @csrf
                ...
                <ul class="footerBtn clearfix">
                    <li>
                        <input type="submit" name="{{ DRAFT }}" value="{{ __('labels.save') }}" class="btn_b"
                           @if($hasSendUser == true) disabled @endif
                        >
                    </li>
                    <li>
                        <input type="submit" name="{{ SUBMIT }}" value="{{ __('labels.btn_send_to_user') }}" class="btn_c"
                           @if($hasSendUser == true) disabled @endif
                        >
                    </li>
                </ul>
...
@section('footerSection')
    ...
    @if (!empty(request()->type) && request()->type == VIEW || $hasSendUser)
