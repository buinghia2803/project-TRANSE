...
@section('main-content')
    ...
    <div id="contents" class="normal">
        ...
        <form
            action="{{ route('user.apply-trademark-without-number-post', $tradeMarkOld ? $tradeMarkOld->id : null) }}"
            ...
            <!--choose pack-->
            @include('user.modules.app-trademark.u031d.includes._choose_pack', [
            ...
            @include('user.modules.app-trademark.u031d.includes._certificate', [
                'appTrademark' => $appTrademark ?? NULL,
            ...
            @include('user.modules.app-trademark.u031d.includes._registration_time', [
                'appTrademark' => $appTrademark ?? NULL,
...
//                'information' => $information,
            ...
            @include('user.modules.app-trademark.u031d.includes._cart', [
                'pricePackage' => $pricePackage,
                'periodRegistration' => $periodRegistration,
...
@section('script')
    <script type="text/JavaScript">
        ...
        const routeAjaxRedirectToU021FromU031b = '{{ route('user.apply-trademark-with-number.redirect-to-regis-precheck') }}';
        const routeAjaxRedirectToU031EditWithNumberFromU031b = '{{ route('user.redirect-to-u031edit-with-number') }}';
        const routeAjaxRedirectToU020bEditFromU031d = '{{ route('user.apply-trademark-with-number.redirect-to-search-ai') }}';
