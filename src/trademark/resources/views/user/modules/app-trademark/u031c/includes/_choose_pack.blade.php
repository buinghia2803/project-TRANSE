...
<table class="normal_b eol">
    <tr>
        <td style="width:34em;">
            <input type="radio" name="pack" class="package_type" {{ $appTrademark && $appTrademark->pack == $packA ? 'checked' : '' }} value="{{ $packA }}" id="package_a" />
            <span
    ...
    <tr>
        <td style="width:34em;">
            <input type="radio" name="pack" class="package_type" {{ $appTrademark && $appTrademark->pack == $packB ? 'checked' : '' }} value="{{ $packB }}" id="package_b" />
    ...
    <tr>
        <td style="width:34em;">
            <input type="radio" name="pack" class="package_type" value="{{ $packC }}" {{ $appTrademark && $appTrademark->pack == $packC ? 'checked' : ($appTrademark ? '' : 'checked') }} id="package_c" />
