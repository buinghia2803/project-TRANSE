...
<p class="eol">
    <input type="checkbox" id="is_mailing_regis_cert" name="is_mailing_regis_cert" {{ old('is_mailing_regis_cert', $appTrademark->is_mailing_regis_cert ?? null) == 1 ? 'checked': '' }} value="1" />
