<div class="estimateBox">
    ...
    <div class="estimateContents">
        ...
        <table class="normal_b">
            <tr>
                <td class="label_text_by_pack">{{ __('labels.u031b.cost_service_base') }}</td>
                <td class="right"><span class="cost_service_base"></span>円</td>
            </tr>
            <tr>
                <td style="width:34em;">{{ __('labels.u031b.add') }}　<span class="count_service_add_prod">0</span>{{ __('labels.u031b.product_name') }}（{{ __('labels.u031b.tree_prod_add_more') }}<span class="cost_service_add_prod_default">0</span>円）</td>
        ...
        <ul class="right list">
            <li><input type="button" value="再計算" class="btn_a recalculationCart" /></li>
        </ul>

        <ul class="right list">
            <li><input type="submit" value="保存・見積書表示" class="btn_a submitRedirectToQuoute" /></li>
        </ul>

        <ul class="footerBtn right clearfix">
            <li><input type="submit" value="この内容で申込む" class="btn_e big submitRedirectToCommonPayment"/>
            </li>
        </ul>
