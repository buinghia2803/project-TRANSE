<table class="normal_b mb10 tm_info">
    <tr>
        <th class="center" style="font-weight: bold">{{__('labels.quote.item')}}</th>
        <th class="center" style="font-weight: bold">{{__('labels.quote.price')}}</th>
    </tr>
    ...
    @if (isset($contentPay['cost_patent_office_text_1']) &&
        ...
        <tr>
            <td>
                {{ $contentPay['cost_patent_office_text_1'] }}
                <span id="sumDistintion2">{{ $contentPay['sum_distinction'] }}</span>区分
                <span
                    id="price_fee_submit_5_year">{{ CommonHelper::formatPrice($contentPay['price_fee_submit_5_year']) }}</span>
                円<br />
                <span id="text_5yrs_10yrs2">
                    {{ $contentPay['stamp_fee_5yrs_text'] ?? '' }}
                </span>
            </td>
            <td class="right">
                <span
